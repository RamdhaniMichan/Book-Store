...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="{{route('books.store')}}" method="POST" enctype="multipart/form-data"
            ...
            <input value="{{old('publisher')}}" type="text" class="form-control {{$errors->first('publisher') ? "is-invalid" : ""}} " id="publisher" name="publisher"
...
<script>
    $('#categories').select2({
        ajax: {
            url: 'http://coba.test/ajax/categories/search',
